  ...
  function Modal({ card, onClose }) {
    ...
    return (
      <div className="fixed inset-0 bg-gray-900 bg-opacity-50 flex items-center justify-center z-50 p-4">
        <div className="bg-white rounded-3xl shadow-inner max-w-lg w-full relative flex flex-col space-y-4 p-6 md:p-8 lg:p-10 xl:p-12 ">
          ...
          <div className={`ml-1 mr-1 w-24 rounded-3xl ${typeColor}`}>
          ...
          <div className="flex flex-col md:flex-row space-y-4 md:space-y-0 md:space-x-4">
            ...
            {activeTab === 'attacks' && (
              <div className={`relative flex-1 p-4 rounded-3xl shadow-lg ${typeColor}`}>
                <img
...
const getBarColor =(type) =>{
  ...
  return (
    <div className="w-full h-full overflow-auto">
      <div className="relative min-h-screen mb-20 ml-20 mr-20">
        <nav className="bg-gray-800 p-6 text-white h-24 shadow-2xl shadow-slate-500 flex items-center fixed top-0 left-0 right-0 z-50">
          <div className="flex items-center">
            ...
            />
            <h1 className="text-3xl font-bold ml-4 mb-6">Pokédex</h1>
          </div>
          <div className="flex-grow flex justify-center ml-12 mr-12 mt-2">
            <input
              type="text"
      ...
      <button
        onClick={scrollToTop}
        className="fixed bottom-4 right-4 bg-gray-500 text-white p-3 shadow-3xl w-12 h-12 rounded-full shadow-lg"
